...
const TemplateExecutive = ({ data, customisation: c }: Props) => {
  ...
  return (
    <div className="cv-shadow rounded-lg overflow-hidden bg-white w-full max-w-[640px] mx-auto" style={{ fontFamily: c.fontFamily, fontSize: `${c.fontSize}px`, color: `hsl(${c.textColour})`, aspectRatio: "210 / 297" }}>
