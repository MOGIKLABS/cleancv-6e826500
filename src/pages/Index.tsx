    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden hero-gradient pt-16">
        ...
        <div className="relative container flex flex-col items-center justify-center py-20 sm:py-32 text-center lg:py-44 px-4">
          <p className="text-[10px] sm:text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-hero-foreground/50 mb-6 sm:mb-8 animate-fade-in font-sans">FREE · NO SIGN-UP · NOTHING STORED. NOTHING SHARED.
